 ...
 */
final class Version20200410105450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE participation (user_id INT NOT NULL, event_id INT NOT NULL, booking_number VARCHAR(30) NOT NULL, booking_at DATETIME NOT NULL, INDEX IDX_AB55E24FA76ED395 (user_id), INDEX IDX_AB55E24F71F7E88B (event_id), PRIMARY KEY(user_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD owner_id INT NOT NULL, CHANGE price price DOUBLE PRECISION DEFAULT NULL, CHANGE capacity capacity INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP owner_id, CHANGE price price DOUBLE PRECISION DEFAULT \'NULL\', CHANGE capacity capacity INT DEFAULT NULL');
        $this->addSql('ALTER TABLE place CHANGE latitude latitude DOUBLE PRECISION DEFAULT \'NULL\', CHANGE longitude longitude DOUBLE PRECISION DEFAULT \'NULL\'');
    }
}
